...
parser.add_argument('--gamma-gp', type=float, default=1, help='gamma for gradient penalty')
parser.add_argument('--e-drift', type=float, default=0.001, help='epsilon drift for discriminator loss')
...
dataset = MNIST(opt.data, download=True, train=True,
                transform=transforms.Compose([transforms.Pad((2, 2)),  # resize to 32x32
                                              transforms.ToTensor(),
